...
<div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/Toyota ch.r 1.jpg" class="img-responsive" alt="image"></a>
<ul>
...
<span class="price">DH<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
